...
# Training the model
def train_model(model, criterion, optimizer, scheduler,log_writer_train, log_writer_val, num_epochs):
    since = time.time()
...
model_ft = train_model(model_ft, criterion, optimizer_ft, exp_lr_scheduler, log_writer_train,log_writer_val, num_epochs=100)